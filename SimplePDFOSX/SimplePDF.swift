...
public class SimplePDF {
        ...
        public class DefaultTextFormatter {
                func attributedStringForStyle(string: String, style: TextStyle) -> NSAttributedString {
                        ...
                        switch(style) {
                        case .H1:
                                attrString.addAttribute(NSFontAttributeName, value:NSFont.boldSystemFontOfSize(24), range: NSMakeRange(0, attrString.length))
                                paragraphStyle.alignment = .Center
                        case .H2:
                                attrString.addAttribute(NSFontAttributeName, value:NSFont.boldSystemFontOfSize(20), range: NSMakeRange(0, attrString.length))
                                paragraphStyle.alignment = .Center
                        case .H3:
                                attrString.addAttribute(NSFontAttributeName, value:NSFont.boldSystemFontOfSize(16), range: NSMakeRange(0, attrString.length))
                                paragraphStyle.alignment = .Center
                        case .H4:
                                attrString.addAttribute(NSFontAttributeName, value:NSFont.boldSystemFontOfSize(14), range: NSMakeRange(0, attrString.length))
                        case .H5:
                                attrString.addAttribute(NSFontAttributeName, value:NSFont.boldSystemFontOfSize(12), range: NSMakeRange(0, attrString.length))
                        case .H6:
                                attrString.addAttribute(NSFontAttributeName, value:NSFont.boldSystemFontOfSize(10), range: NSMakeRange(0, attrString.length))
                        case .BodyText:
                                attrString.addAttribute(NSFontAttributeName, value:NSFont.systemFontOfSize(10), range: NSMakeRange(0, attrString.length))
                        }
        ...
        private class PDFWriter {
                ...
                private func openPDF(path: String, title: String?,  author: String?) -> NSError? {
                        ...
                        pdfContext = CGPDFContextCreateWithURL(url, &pageRect, documentInfo)
                ...
                private func startNewPage(calculationOnly: Bool = false) -> NSRange {
                        if(calculationOnly == false) {
                                ...
                                CGContextTranslateCTM(pdfContext, 0, getPageBounds().size.height);
                ...
                private func addPageHeaderFooter() {
                        ...
                        for var i = 0; i < self.headerFooterTexts.count; i++ {
                                ...
                                textString.mutableString.replaceOccurrencesOfString(kPageNumberPlaceholder, withString: "\(currentPage + 1)", options: [], range: NSMakeRange(0, textString.length))
                                textString.mutableString.replaceOccurrencesOfString(kPagesCountPlaceholder, withString: "\(pagesCount)", options: [], range: NSMakeRange(0, textString.length))
                ...
                private func drawHeaderFooterImage(alignment: NSTextAlignment, image: NSImage, imageHeight: CGFloat, y: CGFloat) {
                        var x:CGFloat = 0
                        ...
                        CIImage.fromNSImage(image)?.flippedImage()?.drawInCGContext(pdfContext!, destRect: imageRect)
                }
                
                // MARK: - Document elements
                private func addH1(string: String, var backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                ...
                private func addH2(string: String, var backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                ...
                private func addH3(string: String, var backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                ...
                private func addH4(string: String, backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                        let attrString = textFormatter.attributedStringForStyle(string, style: .H4)
                        return addAttributedString(attrString, allowSplitting: false, backgroundBoxColor: backgroundBoxColor, calculationOnly: calculationOnly)
                }
                private func addH5(string: String, backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                        let attrString = textFormatter.attributedStringForStyle(string, style: .H5)
                        return addAttributedString(attrString, allowSplitting: false, backgroundBoxColor: backgroundBoxColor, calculationOnly: calculationOnly)
                }
                
                private func addH6(string: String, backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                        let attrString = textFormatter.attributedStringForStyle(string, style: .H6)
                        return addAttributedString(attrString, allowSplitting: false, backgroundBoxColor: backgroundBoxColor, calculationOnly: calculationOnly)
                }
                private func addBodyText(string: String, backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                ...
                private func addImagesRow(imagePaths: [String], imageCaptions: [NSAttributedString], columnWidths: [CGFloat],
                        ...
                        imageBackgroundColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                                ...
                                for var i = 0; i < imagePaths.count; i++ {
                                        ...
                                        if(calculationOnly == false) {
                                                let ciimg = CIImage(contentsOfURL:NSURL(fileURLWithPath:imagePaths[i]))
                                                ciimg?.flippedImage()?.drawInCGContext(pdfContext!, destRect: imageRect)
                                        }
                ...
                private func addAttributedStringsToColumns(columnWidths: [CGFloat], strings: [NSAttributedString], horizontalPadding: CGFloat = 5, allowSplitting: Bool = true, backgroundColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                ...
                private func addAttributedString(attrString: NSAttributedString, allowSplitting:Bool = true, backgroundBoxColor: NSColor? = nil, calculationOnly: Bool = false) -> NSRange {
                ...
                private func addView(view: NSView, calculationOnly: Bool = false) -> NSRange {
                ...
                // MARK: - Drawing
                private func drawRect(rect: CGRect, var fillColor: NSColor? = nil) {
                        if(fillColor == nil) {
                ...
                private func drawLine(p1: CGPoint, p2:CGPoint, var color: NSColor? = nil, strokeWidth: CGFloat = 1) {
                        if(color == nil) {
